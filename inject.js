...
window.onload = function () {
    toastr.info('You are using WebQabuze');
    //alert("Qabuze!");
    setTimeout(function(){
        console.log("User auth token: ");
        console.log(qbPlayer.globalManager.user.auth_token);
    },1000);
    var element = document.getElementById("extras-promotion-button");
    element.parentNode.removeChild(element);
    var element = document.getElementById("user-profile-link");
    element.parentNode.parentNode.removeChild(element.parentNode);
    var element = document.getElementById("facebook-connect-button");
    var parent = element.parentNode;
    while (parent.firstChild) {
        parent.removeChild(parent.firstChild);
    }
    var a = document.createElement('a');
    var linkText = document.createTextNode("Create Account");
    a.appendChild(linkText);
    a.title = "Create Account";
    a.href = "/signup";
    parent.appendChild(a);
    var element = document.getElementsByClassName('signup_link')[0];
    element.parentNode.removeChild(element);
    var element = document.getElementById('logo-container');
    element.innerHTML = '<span style="color: #030303"><img src="/icon.png" style="height: 35px;"/><font size="6"><B>  <sup>WebQabuze</sup></B></font></span>';
    element.parentNode.h
};